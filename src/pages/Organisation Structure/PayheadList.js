...
const deleteHandler=(e,id)=>{
  e.preventDefault()
  axios.delete(`http://localhost:8080/deletepayheadmaster/${id}`).then(res=>console.log(res))
}

useEffect(()=>{
  
  fetch("http://localhost:8080/PayheadMasterDetail").then(res=>res.json()).then(value=>setContacts(value))
},[contacts])
