...
function App() {
  ...
  useEffect(() => {
    console.log(data)
    if (data.email === 'amankumar@gmail.com' && data.password === 'admin') {
      setLogged(!logged)
    }
    else {
      return;
      ...
      {logged &&
        <SideBar>
          <Routes>
            ...
            <Route path="/menuMaster/EmployeeMaster" element={<EmployeeMaster />} />
            <Route path="/menuMaster/AddEmployee" element={<AddEmployee />} />
            <Route path="/menuMaster/DepartmentMaster" element={<DepartmentMaster />} />
            <Route path="/menuMaster/DesignationMaster" element={<DesignationMaster />} />
            <Route path="/menuMaster/EmploymentTypeMaster" element={<EmploymentTypeMaster />} />
            <Route path="/menuMaster/UserApproval" element={<UserApproval />} />
            <Route path="/selfPortal/AttendanceDetails" element={<AttendanceDetails />} />
            <Route path="/selfPortal/CreateLeave" element={<CreateLeave />} />
            <Route path="/selfPortal/MonthlyPerformance" element={<MonthlyPerformance />} />
            <Route path="/selfPortal/RaiseGrievance" element={<RaiseGrievance />} />
            <Route path="/selfPortal/SelfPortal" element={<SelfPortal />} />
            <Route path="/screening&Approval/Attendance Details" element={<AttendanceDetails />} />
            <Route path="/screening&Approval/LeaveAproval" element={<LeaveAproval />} />
            ...
            <Route path="/employeeallowance/EmployeeAllowance" element={<EmployeeAllowance />} />
            <Route path="/employeededuction/EmployeeDeduction" element={<EmployeeDeduction />} />
            <Route path="/organisationStructure/AddHoliday" element={<AddHoliday />} />
            <Route path="/organisationStructure/LeaveType" element={<LeaveType />} />
            <Route path="/organisationStructure/PayheadList" element={<PayheadList />} />
            <Route path="/requirementStructure" element={<Saved />} />
            <Route path="/Recruitment/AddjobTitle" element={<AddJobTitle />} />
            <Route path="//Recruitment/ViewJobTitle" element={<ViewJobTitle />} />
            <Route path="/Recruitment/AddJobVacancy" element={<AddJobVacancy />} />
            <Route path="/Recruitment/FixinInterviewOnline" element={<FixingInterviewOnline />} />
            <Route path="/Recruitment/OnlineApplication" element={<OnlineApplication />} />
            <Route path="/trainingModule/RegisterEmployee" element={<RegisterEmployee />} />
            <Route path="/trainingModule/TainingMaster" element={<TrainingMaster />} />
            <Route path="/trainingModule/TrainingToFeedback" element={<TrainingToFeedback />} />
            <Route path="/advanceOrLoan/LoanMaster" element={<LoanMaster />} />
            <Route path="/advanceOrLoan/LoanApplication" element={<LoanApplication />} />
            <Route path="/attendance/AddIndividualAttendance" element={<AddIndividualAttendance />} />
            <Route path="/attendance/UploadBulkAttendance" element={<UploadBulkAttendance />} />
            <Route path="/attendance/AddOverTime" element={<AddOverTime />} />
            <Route path="/attendance/ViewOtReport" element={<ViewOtReport />} />
            <Route path="/attendance/MonthwiseAbsentReport" element={<MonthwiseAbsentReport />} />
            <Route path="/attendance/MonthwiseAttdReport" element={<MonthwiseAttdReport />} />
            ...
            <Route path="/Shift Management/View Employee Shift" element={<ViewEmployeeShift />} />
